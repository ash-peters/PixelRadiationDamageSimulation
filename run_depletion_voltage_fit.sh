...
cd src
python depletion_voltage_fit/fit_depletion_voltage_data.py -i ${output_simulation_file_name} -dv ${depletion_voltage_file_name} -od ${output_depletion_voltage_directory} -o ${output_depletion_voltage_file_name} -ymin 0 -ymax 800
